...
var RouterMethodFactory = /** @class */ (function () {
    function RouterMethodFactory() {
    }
    RouterMethodFactory.prototype.get = function (target, requestMethod) {
    ...
    RouterMethodFactory.prototype.getKoa = function (target, requestMethod) {
        switch (requestMethod) {
            case request_method_enum_1.RequestMethod.POST:
                return target.post;
            case request_method_enum_1.RequestMethod.ALL:
